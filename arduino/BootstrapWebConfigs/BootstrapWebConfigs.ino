...
void setup() {
  ...
  pinMode(53, OUTPUT);
  Serial.println("-------STEP 1: SD Card Init-------");
  ...
  Serial.println("-------STEP 2: Network Init-------");
  ...
  if (client.connect(server, 80)) {
    ...
    Serial.println("-------STEP 3: Get Configs from Internet-------");
  ...
  if (!useOldConfig){
     Serial.println("-------STEP 4: Write New Configs to SD-------");
     writeConfigsToSD();  
  } else {
  ...
  if (!client.connected()) {
    //Serial.println();
    Serial.println("-------STEP 5: Disconnect from Site Conn-------");
    client.stop();
